...
def negative_mutual_inf_with_shifts(outp: tf.Tensor, inv_transformed_outp: tf.Tensor, MAX_SHIFT=1,
                                    WIDTH=512, HEIGHT=512, BATCH_SIZE=6):
    ...
    def shifted_mutual_infs(MAX_SHIFT=MAX_SHIFT):
...
def conv_loss(te1: tf.Tensor, te2: tf.Tensor,
              WIDTH=256, HEIGHT=256, BATCH_SIZE=6):
    # print(te1, te2)
