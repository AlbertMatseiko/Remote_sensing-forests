...
print("Globals for tuning are:")
path_to_config = './models/' + model_name + '/tuning/'
f_config = open(path_to_config + "tuner_config_globals.txt", "w")
for i, a in enumerate(dict_of_args):
    f_config.write(f"{i} = {a}. \n")
    print(i, a)
f_config.close()
